...
<body style="background:#fff;">
    ...
    <style> 
        ...
        .bricon
        {
            background: url(<?=base_url();?>assets/slider/img/browser-icons.png);
        }
    </style>
    <!-- it works the same with all jquery version from 1.x to 2.x -->
    <script type="text/javascript" src="<?=base_url();?>assets/slider/js/jquery-1.9.1.min.js"></script>
    <!-- use jssor.slider.mini.js (40KB) or jssor.sliderc.mini.js (32KB, with caption, no slideshow) or jssor.sliders.mini.js (28KB, no caption, no slideshow) instead for release -->
    <!-- jssor.slider.mini.js = jssor.sliderc.mini.js = jssor.sliders.mini.js = (jssor.core.js + jssor.utils.js + jssor.slider.js) -->
    <script type="text/javascript" src="<?=base_url();?>assets/slider/js/jssor.core.js"></script>
    <script type="text/javascript" src="<?=base_url();?>assets/slider/js/jssor.utils.js"></script>
    <script type="text/javascript" src="<?=base_url();?>assets/slider/js/jssor.slider.js"></script>
    <script>
        ...
        <style>
            ...
            */
            .jssora05l, .jssora05r, .jssora05ldn, .jssora05rdn
            {
            	...
            	cursor: pointer;
            	display: block;
                background: url(<?=base_url();?>assets/slider/img/a17.png) no-repeat;
                overflow:hidden;
            }
