...
<div style="margin-bottom: 5px;text-align: right;">
    <input type="button" onclick="window.history.back();" class="btn btn-danger" value="Back" />
</div>
    ...
    <div class="panel-body" id="panelx">
        <div class="row" style="font-size: 12px;">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <label>Address</label>
                    <textarea class="form-control" name="address" disabled><?=$list_locator->address;?></textarea>
                </div>
                <div class="form-group">
