<?php
class M_mediafeature extends CI_Model{
        ...
        public function handler4($searchterm)
	{
            if($searchterm)
            {
                    $this->session->set_userdata('weblink_sr', $searchterm);
                    return $searchterm;
            }
            elseif($this->session->userdata('weblink_sr'))
            {
                    $searchterm = $this->session->userdata('weblink_sr');
                    return $searchterm;
            }
            else
            {
        ...
        public function handler5($searchterm)
	{
            if($searchterm)
            {
                    $this->session->set_userdata('category_sr', $searchterm);
                    return $searchterm;
            }
            elseif($this->session->userdata('category_sr'))
            {
                    $searchterm = $this->session->userdata('category_sr');
                    return $searchterm;
            }
            else
            {
        ...
        public function handlerx($ses,$searchterm)
	{
            if($searchterm)
            {
