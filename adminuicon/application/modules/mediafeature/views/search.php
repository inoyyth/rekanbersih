                      ...
                      <?php }} ?>
                        <tr>
                            <form method="post" action="<?=base_url();?>mediafeature/search" id="form1"/>
                                ...
                                <td><input name="weblink_sr" class="form-control" value="<?=$weblink_sr;?>" style="width: 100%;" type="text" onkeyup="javascript:if(event.keyCode == 13){coba('form1');}else{return false;};"/></td>
...
<script type="text/javascript">
    $(document).ready(function (){
        ...
        function indexx(){
        window.location.replace("<?php echo base_url(); ?>mediafeature");
        }
        function updatex(id){
