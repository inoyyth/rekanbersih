        ...
        <div class="panel-body">
            <div style="margin-bottom: 5px;">
                <input type="button" class="btn btn-primary btn-xs" value=" + New" id="new" />
                    <form method="post" action="<?=base_url();?>brand_management/search" id="form2"/>
                    ...
                    <tfoot>
                        <tr>
                            <form method="post" action="<?=base_url();?>brand_management/search" id="form1"/>
                                ...
                                <td><input name="child_sr" class="form-control" style="width: 100%;" type="text" onkeyup="javascript:if(event.keyCode == 13){coba('form1');}else{return false;};"/></td>
