<?php
class M_article_subcategory extends CI_Model{
        ...
        public function handler4($searchterm)
	{
            if($searchterm)
            {
                    $this->session->set_userdata('categoryname_sr', $searchterm);
                    return $searchterm;
            }
            elseif($this->session->userdata('categoryname_sr'))
            {
                    $searchterm = $this->session->userdata('categoryname_sr');
                    return $searchterm;
            }
            else
            {
