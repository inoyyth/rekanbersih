...
<div class="panel panel-default">
    <div class="panel-heading">Article Sub Category</div>
                      ...
                      <?php }} ?>
                        <tr>
                            <form method="post" action="<?=base_url();?>article_subcategory/search" id="form1"/>
                                ...
                                <td><input name="categoryname_sr" class="form-control" style="width: 100%;" type="text" onkeyup="javascript:if(event.keyCode == 13){coba('form1');}else{return false;};"/></td>
