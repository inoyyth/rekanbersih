    ...
    <div style="margin-top: 5px; margin-bottom: 5px;">
        ...
        <select name="category_sr" style="width: 80px;">
            ...
            <?php foreach($category as $categoryx){
                if($categoryx->id==$category_sr){
                    $cek="selected";
                }else{
                    $cek="";
                }
            ?>
            <option value="<?=$categoryx->id;?>" <?=$cek;?>><?=$categoryx->article_category_name;?></option>
            <?php } ?>
        </select>
        Subcategory:
        <select name="subcategory_sr" style="width: 80px;">
            ...
            <?php foreach($subcategory as $subcategoryx){
                if($subcategoryx->id==$subcategory_sr){
                    $cek2="selected";
                }else{
                    $cek2="";
                }
            ?>
            <option value="<?=$subcategoryx->id;?>" <?=$cek2;?>><?=$subcategoryx->article_subcategory_name;?></option>
            <?php } ?>
        </select>
        Keyword:
        <input type="text" name="name_sr" value="<?=$name_sr;?>" style="width: 80px;">
