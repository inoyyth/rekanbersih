<?php
class M_store_management extends CI_Model{
        ...
        public function handler4($searchterm)
	{
            if($searchterm)
            {
                    $this->session->set_userdata('city_sr', $searchterm);
                    return $searchterm;
            }
            elseif($this->session->userdata('city_sr'))
            {
                    $searchterm = $this->session->userdata('city_sr');
                    return $searchterm;
            }
            else
            {
