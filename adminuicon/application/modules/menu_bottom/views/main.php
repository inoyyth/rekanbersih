<ol class="breadcrumb">
    <li> Menu</li>
    <li class="active"></i> Menu Bottom</li>
</ol>
...
<input type="button" class="btn btn-primary btn-xs" style="margin-bottom: 5px;" value="Top Menu" onclick="window.location.replace('<?=base_url();?>menu_bottom');" />
<input type="button" class="btn btn-primary btn-xs" style="margin-bottom: 5px;" value="Bottom Menu" disabled />
...
<div class="panel panel-default">
    <div class="panel-heading">Menu Bottom Management</div>
            ...
            <table class="table table-bordered table-hover table-striped">
                ...
                ?>
                  ...
                  <?php
                    $idx1=$data->id;
                    //data sub menu 1
                    $sql1=mysql_query("select a.*,b.menu_type as menu_typex from menu_bottom a left join menu_type b on a.menu_type=b.id where a.menu_parent_id='$idx1' and a.menu_index='1' order by a.menu_position asc");
                    $max1=mysql_query("select max(menu_position) as max_pos from menu_bottom where menu_parent_id='$idx1' and menu_index='1'");
                    $min1=mysql_query("select min(menu_position) as min_pos from menu_bottom where menu_parent_id='$idx1' and menu_index='1'");
                  ...
                  ?>
                    ...
                    $idx2=$data1['id'];
                    //data sub menu 1
                    $sql2=mysql_query("select a.*,b.menu_type as menu_typex from menu_bottom a left join menu_type b on a.menu_type=b.id where a.menu_parent_id='$idx2' and a.menu_index='2' order by a.menu_position asc");
                    $max2=mysql_query("select max(menu_position) as max_pos from menu_bottom where menu_parent_id='$idx2' and menu_index='2'");
                    $min2=mysql_query("select min(menu_position) as min_pos from menu_bottom where menu_parent_id='$idx2' and menu_index='2'");
                    ...
                    $idx3=$data2['id'];
                    //data sub menu 1
                    $sql3=mysql_query("select a.*,b.menu_type as menu_typex from menu_bottom a left join menu_type b on a.menu_type=b.id where a.menu_parent_id='$idx3' and a.menu_index='3' order by a.menu_position asc");
                    $max3=mysql_query("select max(menu_position) as max_pos from menu_bottom where menu_parent_id='$idx3' and menu_index='3'");
                    $min3=mysql_query("select min(menu_position) as min_pos from menu_bottom where menu_parent_id='$idx3' and menu_index='3'");
                    ...
                    $idx4=$data3['id'];
                    //data sub menu 1
                    $sql4=mysql_query("select a.*,b.menu_type as menu_typex from menu_bottom a left join menu_type b on a.menu_type=b.id where a.menu_parent_id='$idx4' and a.menu_index='4' order by a.menu_position asc");
                    $max4=mysql_query("select max(menu_position) as max_pos from menu_bottom where menu_parent_id='$idx4' and menu_index='4'");
                    $min4=mysql_query("select min(menu_position) as min_pos from menu_bottom where menu_parent_id='$idx4' and menu_index='4'");
                    ...
                    $idx5=$data4['id'];
                    //data sub menu 1
                    $sql5=mysql_query("select a.*,b.menu_type as menu_typex from menu_bottom a left join menu_type b on a.menu_type=b.id where a.menu_parent_id='$idx5' and a.menu_index='5' order by a.menu_position asc");
                    $max5=mysql_query("select max(menu_position) as max_pos from menu_bottom where menu_parent_id='$idx5' and menu_index='5'");
                    $min5=mysql_query("select min(menu_position) as min_pos from menu_bottom where menu_parent_id='$idx5' and menu_index='5'");
...
<script type="text/javascript">
    $(document).ready(function (){
        $("#new").click(function(){
           window.location.replace("<?php echo base_url(); ?>menu_bottom/add");
        });
        });
        function updatex(id){
        window.location.replace("<?php echo base_url(); ?>menu_bottom/update/"+id);
        }
        function deletex(id){
            $.ajax({
                type: "POST",
                url: "<?= base_url(); ?>menu_bottom/cek_delete",
                data: "id="+id,
                success: function (dt) {
                    if(dt==="1"){
                        if(confirm('This Menu Have Children, Delete This Menu ?')){
                        window.location.replace("<?php echo base_url(); ?>menu_bottom/delete/"+id);
                        }
                    }else{
        ...
        function naik(menuparent,menuid,menuposition){
            ...
            window.location.replace("<?php echo base_url(); ?>menu_bottom/naik/"+menuparent+"/"+menuid+"/"+menuposition);
        }
        function turun(menuparent,menuid,menuposition){
            //alert(menuparent+"-"+menuid);
            window.location.replace("<?php echo base_url(); ?>menu_bottom/turun/"+menuparent+"/"+menuid+"/"+menuposition);
        }
</script>