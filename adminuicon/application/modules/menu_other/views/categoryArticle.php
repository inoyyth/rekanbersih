...
<script language="javascript">
   function setModel(id,category_name,url){
     window.opener.document.forms[0].kodex.value = "category_article/index/"+id+"/"+url;
...
<div style="margin-top: 5px; margin-bottom: 5px;">List Category Article</div>
<form method="post" action="<?=base_url();?>menu/category_article_search">
  ...
  <tr>
    ...
    <td align="center">
        <a href="javascript:setModel(
           ...
           '<?php echo $articlex->article_category_name; ?>',
           '<?php echo url($articlex->article_category_name); ?>'
        );" style="color:#FF0000">
        <?php echo $articlex->article_category_name; ?></a>
    </td>
  </tr>
  <?php } ?>
</table>
