...
<script language="javascript">
   function setModel(id,category_name,url){
     window.opener.document.forms[0].kodex.value = "category_commerce/index/"+id+"/"+url;
...
<div style="margin-top: 5px; margin-bottom: 5px;">List Category Commerce</div>
<form method="post" action="<?=base_url();?>menu/category_commerce_search">
    <div style="margin-top: 5px; margin-bottom: 5px;">
        Search By: 
        Keyword:
        <input type="text" name="name_sr" value="<?=$name_sr;?>">
  ...
  <tr>
    ...
    <td align="center">
        <a href="javascript:setModel(
           ...
           '<?php echo $articlex->product_category_name; ?>',
           '<?php echo url($articlex->product_category_name); ?>'
        );" style="color:#FF0000">
        <?php echo $articlex->product_category_name; ?></a>
    </td>
  </tr>
  <?php } ?>
</table>
