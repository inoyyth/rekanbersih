                ...
                <tfoot>
                    <tr>
                        <form method="post" action="<?=base_url();?>adds/search" id="form1"/>
                            ...
                            <td><input name="url_sr" value="<?=$url_sr;?>" class="form-control" style="width: 100%;" type="text" onkeyup="javascript:if(event.keyCode == 13){coba('form1');}else{return false;};"/></td>
...
<script type="text/javascript">
    ...
    function indexx(){
        window.location.replace("<?php echo base_url(); ?>adds");
    }
</script>