                      ...
                      <?php }} ?>
                        ...
                        <tr>
                            <form method="post" action="<?=base_url();?>filter_category/search" id="form1"/>
                                ...
                                <td><input name="category_sr" value="<?=$category_sr;?>" class="form-control" style="width: 100%;" type="text" onkeyup="javascript:if(event.keyCode == 13){coba('form1');}else{return false;};"/></td>
...
<script type="text/javascript">
    $(document).ready(function (){
        ...
        function indexx(){
        window.location.replace("<?php echo base_url(); ?>filter_category");
        }
        function updatex(id){
