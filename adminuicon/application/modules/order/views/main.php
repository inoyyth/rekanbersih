                    ...
                    <tfoot>
                        <tr>
                            <form method="post" action="<?=base_url();?>order/search" id="form1"/>
                                ...
                                <td><input name="invoice_sr" class="form-control" style="width: 100%;" type="text" onkeyup="javascript:if(event.keyCode == 13){coba('form1');}else{return false;};"/></td>
                                ...
                                <td></td>
                                <td><input name="payment_sr" class="form-control" style="width: 100%;" type="text" onkeyup="javascript:if(event.keyCode == 13){coba('form1');}else{return false;};"/></td>
