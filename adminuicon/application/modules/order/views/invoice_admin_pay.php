...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>Your order #<?=$number_order;?> Is Being Processed.</title>
		<style type="text/css">
			h1,h2,h3,h4,h5 {
				color:#3a3a3a;
			}
	...
	<body style="width:100%;background-color:#f6f6f6;font-size:13px;color:#656565;font-family: Arial, Helvetica, sans-serif">
		<table align="center" bgcolor="#fff" width="600px" cellpadding="10" cellspacing="0" border="0" style="margin:auto">
			...
			<tr>
				<td style="padding:0px 10px"><h2>Your Order Is Being Processed.</h2></td>
			</tr>
			<tr>
				<td>
					<p style="font-size:16px">Status order <span style="color:#e20025"><strong>#<?=$number_order;?></strong> (<?=$email;?>)</span> is being processed</p>
					<p><?=$billing->firstname_custbilling;?> <?=$billing->firstname_custbilling;?>,<br/><br/>Thank you for ordering from Urban Icon online store. Please see order details below. You can see this order by <a href="http://urbanicon.co.id/register" target="_blank"><strong>Logging in into your account</a></p>
			...
			<tr>
					...
					<tr>
						...
						<td style="width:50%;vertical-align:top">
							...
							<p>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <P>You will receive shipment advise and tracking number within approximately 24-48 hours. Order on Saturday and Sunday will be processed on Monday.</P>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
				...
				<table align="center" bgcolor="#fff" width="600px" cellpadding="0" cellspacing="0" border="0" style="margin:auto;padding:20px 10px;border-top:1px solid #eaeaea">
					...
					<img src="<?=base_url();?>userfiles/Image/emails/36px_google.png" alt="Google+" >
							</a>	
