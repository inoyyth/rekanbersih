...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>Your order #<?=$number_order;?> is now shipped.</title>
		<style type="text/css">
			h1,h2,h3,h4,h5 {
				color:#3a3a3a;
			}
	...
	<body style="width:100%;background-color:#f6f6f6;font-size:13px;color:#656565;font-family: Arial, Helvetica, sans-serif">
		<table align="center" bgcolor="#fff" width="600px" cellpadding="10" cellspacing="0" border="0" style="margin:auto">
			...
			<tr>
				<td style="padding:0px 10px"><h2>Your Order is now shipped.</h2></td>
			</tr>
			<tr>
				<td>
					<p style="font-size:16px">Status order <span style="color:#e20025"><strong>#<?=$number_order;?></strong> (<?=$email;?>)</span> is now shipped</p>
					<p><?=$billing->firstname_custbilling;?> <?=$billing->lastname_custbilling;?>,<br/><br/>Thank you for ordering from Urban Icon online store. Please see order details below. You can see this order by <a href="http://urbanicon.co.id/register" target="_blank"><strong>Logging in into your account</a></p>
