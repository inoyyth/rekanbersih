		...
		<table align="center" bgcolor="#fff" width="600px" cellpadding="10" cellspacing="0" border="0" style="margin:auto">
			...
			<tr>
				<td>
					...
					<p><?=$billing->firstname_custdetail;?> <?=$billing->firstname_custdetail;?>,<br/><br/>Thank you for ordering from Urban Icon online store. Please see order details below. You can see this order by <a href="http://urbanicon.co.id/register" target="_blank"><strong>Logging in into your account</a></p>
