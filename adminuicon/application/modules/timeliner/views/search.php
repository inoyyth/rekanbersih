                      ...
                      <?php }} ?>
                        <tr>
                            <form method="post" action="<?=base_url();?>timeliner/search" id="form1"/>
                                ...
                                <td><input name="content_sr" value="<?=$content_sr;?>" class="form-control" style="width: 100%;" type="text" onkeyup="javascript:if(event.keyCode == 13){coba('form1');}else{return false;};"/></td>
                                <td><input name="year_sr" class="form-control" value="<?=$year_sr;?>" style="width: 100%;" type="text" onkeyup="javascript:if(event.keyCode == 13){coba('form1');}else{return false;};"/></td>
...
<script type="text/javascript">
    $(document).ready(function (){
        $("#new").click(function(){
         ...
         function indexx(){
        window.location.replace("<?php echo base_url(); ?>timeliner");
        }
        function updatex(id){
