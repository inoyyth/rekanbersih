...
$base_url="http://localhost/cms"; //url base of site if you want only relative url leave empty
$upload_dir = '/mce/tinymce/source'; // path from base_url to upload base dir
